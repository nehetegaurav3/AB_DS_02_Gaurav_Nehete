...
/*
    ...
    @return: Status
*/
extern  status_t MVDCLLQuickSort(p_mv_dcll_t list, compare_proc_t pcompareproc)
{
	//Code
	CHECK_LIST_ERRORS(list, CHECK_LIST | CHECK_SIZE);

	MVQuickSort(list, 0, MVDCLLSize(list) - 1, pcompareproc, MVDCLLDataAt, MVDCLLSetDataAt);
...
/*
    ...
    @return: Status
*/
extern  status_t MVDCLLQuickSortN(p_mv_dcll_t list, compare_proc_t pcompareproc, long long no_of_elements)
{
	//Code
	CHECK_LIST_ERRORS(list, CHECK_LIST | CHECK_SIZE);

	MVQuickSort(list, 0, (no_of_elements - 1), pcompareproc, MVDCLLDataAt, MVDCLLSetDataAt);
...
/*
    ...
    @return: Status
*/
extern  status_t MVDCLLQuickSortSE(p_mv_dcll_t list, compare_proc_t pcompareproc, long long start, long long end)
{
	//Code
	CHECK_LIST_ERRORS(list, CHECK_LIST | CHECK_SIZE);

	MVQuickSort(list, start, end, pcompareproc, MVDCLLDataAt, MVDCLLSetDataAt);

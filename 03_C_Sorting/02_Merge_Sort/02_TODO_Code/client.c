...
/*
    ...
    @date: 20 July 2023 (Thursday) 03:02 PM  
*/
#include	<stdio.h>
#include	<stdlib.h>
...
int main(void)
{
	...
	MVDCLLMergeSort(list1, compare_inequality);
	fprintf(stdout, "After List1 Sort:\n");
	print_list(list1);

	MVDCLLMergeSortN(list2, compare_inequality, 5);
	fprintf(stdout, "After List2 Sort:\n");
	print_list(list2);

	MVDCLLMergeSortSE(list3, compare_inequality, 2, 8);
